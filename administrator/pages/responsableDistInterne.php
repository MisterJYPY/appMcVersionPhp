...
WHERE personnel.actif='actif' AND personnel.fonction='RESPONSABLE DISTRIBUTEUR INTERNE'";
 $entete=array("nom"=>"Nom ","prenom"=>"prenom","designation"=>"service");
     //$entete=null;           
  $tab=new Tableau($sql4,"col-lg-12",'<div id="page-wrapper">',"Liste De Tous les Rdi",$entete);
